       ...
       useEffect(() => {
         const fetchData = async () => {
           try {
             ...
             console.log('Fetched deals:', dealsResponse.data);
             console.log('Fetched games IDs:', gamesResponse.data.map(g => g.id));
         ...
         <div className="container mx-auto py-8 px-4">
           ...
           <div className="space-y-4">
             ...
             {deals.map((deal) => {
               ...
               if (!game) {
                 console.warn(`No game found for deal with gameId: ${deal.gameId}`);
                 return null;
               }
               return <DealItem key={deal.id} deal={deal} game={game} />;
             })}
           </div>
         </div>
       );
